...
export const products: Product[] = [
  ...
  { slug: "tabandan-besleme-nozulu", name: "Tabandan Besleme Nozulu (Debi Ayarlı)", categorySlug: "havuz-kenar-ve-ic-ekipmanlari", image: "/images/products/havuz-kenar-ve-ic-ekipmanlari/tabandanbeslemenozulu_beyaz.jpeg", description: "Tabandan besleme nozulu, yüzme havuzlarında filtrelenmiş suyu tabandan ve debi ayarlı biçimde veren 2″ bağlantılı yapıştırma tip nozuldur; düz inişli tasarımı ile suyun havuz tabanına yönlendirilmesini ve homojen dağılımını sağlar.", colorOptions: [{ label: "Beyaz", image: "/images/products/havuz-kenar-ve-ic-ekipmanlari/tabandanbeslemenozulu_beyaz.jpeg" }, { label: "Siyah", image: "/images/products/havuz-kenar-ve-ic-ekipmanlari/tabandanbeslemenozulu_siyah.jpeg" }], tags: ["nozul", "besleme"] },
