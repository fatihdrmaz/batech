      ...
      <div className="relative bg-batech-navy text-white py-10 lg:py-14 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex flex-wrap items-center gap-1.5 text-sm text-batech-silver mb-6" aria-label="Breadcrumb">
            <Link href="/" className="hover:text-batech-cyan transition-colors">{t("product.breadcrumb.home")}</Link>
            <span className="text-white/40" aria-hidden>/</span>
            <Link href="/urunler" className="hover:text-batech-cyan transition-colors">{t("product.breadcrumb.products")}</Link>
            {category && (
              <>
                <span className="text-white/40" aria-hidden>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-12">
                  ...
                  <table className="w-full min-w-[400px] text-sm">
                    <thead>
                      <tr className="bg-batech-pearl/50 border-b border-batech-pearl">
                        <th className="text-left py-4 px-6 font-semibold text-batech-navy">{t("product.variantCode")}</th>
                        <th className="text-left py-4 px-6 font-semibold text-batech-navy">{t("product.variantName")}</th>
                        {product.variants.some((v) => v.note) && (
                          <th className="text-left py-4 px-6 font-semibold text-batech-navy">{t("product.variantNote")}</th>
                        )}
                      </tr>
                    </thead>
                    <tbody>
            ...
            {product.tags && product.tags.length > 0 && (
              <section>
                <h2 className="text-lg font-semibold text-batech-navy mb-3">{t("product.tags")}</h2>
          ...
          <div className="space-y-8">
            ...
            {related.length > 0 && (
              <div className="rounded-2xl border border-batech-pearl bg-batech-pearl/20 p-6">
                <h3 className="font-semibold text-batech-navy mb-4">{t("product.related")}</h3>
